...
function getOptionButtons(setNotPass:Function,adoptFunction:Function,auditStatus:number,setVisible:React.Dispatch<React.SetStateAction<boolean>>) {
...
function getExtra(Info:UserModelState) {
